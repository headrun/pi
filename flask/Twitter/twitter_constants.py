...
update_qry = 'update twitter_crawl set crawl_status=1 where sk="%s" and crawl_status =9'

select_qry = 'select  sk,url,meta_data from twitter_crawl where crawl_status = 0 limit 80'

upd_qry = 'update twitter_crawl set crawl_status=9 where sk= "%s" and crawl_status=0'
