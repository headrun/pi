...
email_dev_list = ['kiranmayi@headrun.net']
...
twitter_select_qry = 'select  sk, url, meta_data from twitter_crawl where crawl_status = 0 and (modified_at between "%s" and "%s") limit 80'
