...
#email_dev_list = ['kiranmayi@headrun.net', 'aravind@headrun.com', 'anushab@headrun.net']
#email_dev_list = ['kiranmayi@headrun.net', 'anushab@headrun.net', 'sraju@headrun.net']
email_dev_list = ['sraju@headrun.net']
#email_prod_list = ['kiranmayi@headrun.net', 'aravind@headrun.com', 'yatish@headrun.com', 'karthik@headrun.com']
email_prod_list = ['kiranmayi@headrun.net']
sender_mail_pi = 'positiveintegersproject@gmail.com'
sender_pwd_pi = 'integers'
#mailids_from_list = ['kiranmayi@headrun.net', 'chetan.m@positiveintegers.com', 'aravind@headrun.com']
#mailids_from_list = ['kiranmayi@headrun.net']
mailids_from_list = ['sraju@headrun.net', 'kiranmayi@headrun.net']
...
twitter_update_qry = 'update twitter_crawl set crawl_status=1 where sk="%s" and crawl_status =9 and date(created_at)=curdate()'
...
twitter_select_qry = 'select  sk, url, meta_data from twitter_crawl where crawl_status = 0 and date(created_at) = curdate()'

twitter_upd_qry = 'update twitter_crawl set crawl_status=9 where sk= "%s" and crawl_status=0 and date(created_at) = curdate()'
...
#fb_constants
#constants_dict_fb = {'praneeth':['praneeth@headrun.com','praneeth@123'],'bala':['balakumaridevara@gmail.com','bala123123'],'pos':['positiveintegersproject@gmail.com','integersproject'], 'venu':['venu.kallakunta', 'venu@123'],'email':['yagnasree@headrun.com','yagna^123'],'kolla':['kollaprasanthi1997@gmail.com','515515515']}
#constants_dict_fb = {'praneeth':['praneeth@headrun.com','praneeth@123'],'email':['yagnasree@headrun.com','yagna^123']}
constants_dict_fb = {'anush':['anusha.boyina19@gmail.com','EzxOctanusha'], 'kiran':['lckiranmayi9@gmail.com', 'dotoday1!']}
#constants_dict_fb = {'show':['multihowkiran@gmail.com','kirany@dumbu'], 'yagna':['yagnasree@headrun.com', 'yagna^123'], 'veveo':['vtvmycloud@gmail.com', 'veveo123']}
...
#linkedin_constants
mails_dict_ln = {'ramanujan':['srinivasaramanujan427@gmail.com','dotoday1#'],'meatproject':['meatproject05@gmail.com','ram123123'],'ccv':['ccvy1.pavani1886@gmail.com','ccvy1.pavani@1886'],'smiley':['smileykutie@gmail.com','smileykutie$'], 'raja':['rajaqx@gmail.com','linkedinpw']}
...
login_cmds_ip_ln = ['/usr/local/bin/scrapy crawl linkedinapivoyager_browse -a login="ramanujan" --set ROBOTSTXT_OBEY=0 --set HTTPCACHE_ENABLED=0  --set HTTP_PROXY="http://176.9.181.37:3279" -a mpi="%s"', 'scrapy crawl linkedinapivoyager_browse -a login="meatproject" --set ROBOTSTXT_OBEY=0 --set HTTPCACHE_ENABLED=0  --set HTTP_PROXY="http://176.9.181.40:3279" -a mpi="%s"']
