...
class LinkedinPipeline(object):
	...
	if isinstance(item, Linkedingroups):
		query = 'INSERT INTO linkedin_groups(sk, profile_sk, group_link, group_name, no_of_members, group_logo, group_id, created_at, modified_at, last_seen)values(%s,%s,%s,%s,%s,%s,%s,now(), now(), now()) ON DUPLICATE KEY UPDATE last_seen=now(), sk=%s, profile_sk=%s, group_link=%s, group_name=%s, no_of_members=%s, group_logo=%s, group_id=%s'
		values = (item.get('sk',''), item.get('profile_sk',''), item.get('group_link',''), item.get('group_name',''), item.get('no_of_members',''), item.get('group_logo',''), item.get('group_id',''),item.get('sk',''), item.get('profile_sk',''), item.get('group_link',''), item.get('group_name',''), item.get('no_of_members',''), item.get('group_logo',''), item.get('group_id',''))
                self.cursor.execute(query, values)
                self.conn.commit()
	if isinstance(item, Linkedineducations):
		query = 'INSERT INTO linkedin_educations(sk, profile_sk, edu_start_year, edu_start_month, edu_start_date, edu_end_year, edu_end_date, edu_end_month, edu_degree, edu_field_of_study, edu_school_name, school_logo, post_article_id, education_id, school_id, created_at, modified_at, last_seen) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,now(), now(), now()) ON DUPLICATE KEY UPDATE last_seen=now(),sk=%s, profile_sk=%s, edu_start_year=%s, edu_start_month=%s, edu_start_date=%s, edu_end_year=%s, edu_end_date=%s, edu_end_month=%s, edu_degree=%s, edu_field_of_study=%s, edu_school_name=%s, school_logo=%s, post_article_id=%s, education_id=%s, school_id=%s'
                values = (item.get('sk',''), item.get('profile_sk',''), item.get('edu_start_year',''), item.get('edu_start_month',''), item.get('edu_start_date',''), item.get('edu_end_year',''), item.get('edu_end_date',''), item.get('edu_end_month',''), item.get('edu_degree',''), item.get('edu_field_of_study',''), item.get('edu_school_name',''), item.get('school_logo',''), item.get('post_article_id',''), item.get('education_id',''), item.get('school_id',''),item.get('sk',''), item.get('profile_sk',''), item.get('edu_start_year',''), item.get('edu_start_month',''), item.get('edu_start_date',''), item.get('edu_end_year',''), item.get('edu_end_date',''), item.get('edu_end_month',''), item.get('edu_degree',''), item.get('edu_field_of_study',''), item.get('edu_school_name',''), item.get('school_logo',''), item.get('post_article_id',''), item.get('education_id',''), item.get('school_id',''))
                self.cursor.execute(query, values)
                self.conn.commit()
	...
	if isinstance(item, Linkedinhonors):
		query = 'INSERT INTO linkedin_honors(sk, profile_sk, honor_on, honor_issuer, honor_summary, occupation, created_at, modified_at, last_seen) values (%s,%s,%s,%s,%s,%s,now(), now(), now()) ON DUPLICATE KEY UPDATE last_seen=now(),sk=%s, profile_sk=%s, honor_on=%s, honor_issuer=%s, honor_summary=%s, occupation=%s'
                values = (item.get('sk',''), item.get('profile_sk',''), item.get('honor_on',''), item.get('honor_issuer',''), item.get('honor_summary',''), item.get('occupation',''), item.get('sk',''), item.get('profile_sk',''), item.get('honor_on',''), item.get('honor_issuer',''), item.get('honor_summary',''), item.get('occupation',''))
                self.cursor.execute(query, values)
                self.conn.commit()
