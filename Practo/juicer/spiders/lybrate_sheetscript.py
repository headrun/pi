...
class Lybratecsv(object):
    def __init__(self, *args, **kwargs):
        ...
        self.query1 = 'select * from %s where date(modified_at) >= "2017-11-20"'
        self.query2 = 'select * from %s where %s = "%s"'
        self.columns_query = 'SELECT COLUMN_NAME FROM information_schema.columns where table_schema= "LYBRATE" and table_name = "%s"'
