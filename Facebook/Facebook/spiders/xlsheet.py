...
class xlsfile(object):
	...
	self.cur = self.con.cursor()
        self.row_count = 1
        self.excel_file_name = 'facebook_profiles_%s.xls'%str(datetime.datetime.now().date())
    ...
    def send_xls(self):
	    ...
	    self.cur.execute(update_getc_params%('updatedrecord',sk1))
            if 'Facebook' in name1: name1=''
            if 'Add Mobile Number' in name1: name1=''
