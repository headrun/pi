...
class Fbnew(BaseSpider):
	...
	#self.profiles_list = ['https://www.facebook.com/sunderraj25']
	self.profiles_list =  ['https://www.facebook.com/aswin.iyer.9']
	#self.profiles_list = ['https://www.facebook.com/rajaqx']
