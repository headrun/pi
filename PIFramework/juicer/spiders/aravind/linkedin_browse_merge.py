...
class linkedinBmerge(BaseSpider):
	...
	self.file_name = kwargs.get('file', 'linkedin.txt')
	...
	with open(self.file_name, 'r') as f:
		...
		for i in fr:
			i  =  i.strip()
			self.listprofiles.append(i)
        #self.listprofiles = ['https://in.linkedin.com/in/kenneth-khong-9267b451']
	self.listprofiles = ['https://in.linkedin.com/in/eiril-anwar-rosli-b6a45164']
        '''self.listprofiles = [
        ...
        self.row_count = 1
        self.excel_file_name = 'linkedin_profiles_.xls'
    ...
    def parse_next(self, response):
        sel = Selector(response)
        headers = {'User-Agent': "Mozilla/5.0 (Linux; Pibot; +http://positiveintegers.com) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36"}
