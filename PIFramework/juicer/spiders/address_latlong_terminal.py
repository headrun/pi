...
class AddressLatLongTerminal(JuicerSpider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.address_qry = 'insert into new_address(key_value,address_original,address_new,formatted_address,geometry_bounds_ne_lat,geometry_bounds_ne_lng,geometry_bounds_sw_lat,geometry_bounds_sw_lng,location_lat,location_lng,location_type,viewport_ne_lat,viewport_ne_lng,viewport_sw_lat,viewport_sw_lng,partial_match,place_id,types,status,reference_url,long_name,short_name,component_type,mobile_no) values (%s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s ,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)'       
