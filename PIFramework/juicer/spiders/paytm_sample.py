...
class PaytmSample(JuicerSpider):
    name = 'paytm_sample_browse'
    ...
    def __init__(self, *args, **kwargs):
        super(PaytmSample, self).__init__(*args, **kwargs)
    ...
    def spider_closed(self, spider):
        ...
        file_id = Googleupload().main('paytm', email_from_list, self.excel_file_name)
        self.alert_mail(0, 0, 0, email_from_list, 'again', file_id, self.excel_file_name)
    ...
    def alert_mail(self, totalc, avai, unava, email_from_list, again, file_id, facebook_file_name):
        ...
        if not again:
                ...
                mas += '<p>File is uploaded in Linkedin [sub-folder] of  PositiveIntegers [folder] in google drive of %s</p>' % sender_mail
