...
class Lixlsfile(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        header_params = ['source', 'search_keyword', 'title', 'post_text', 'author', 'post_timestamp', 'star_rating', 'count_views', 'count_likes', 'count_comments', 'count_replies', 'count_helpful', 'location', 'flake_flag', 'no_of_reviews', 'review url', 'author_url', 'review_text']
    ...
    def send_xls(self):
        ...
        for db in dbs:
            ...
            for record in records:
                ...
                aux_infof = {}
                try: aux_infof = json.loads(aux_info.replace('\\',''))
                except: pass
                ...
                values = [db.lower(), keywor, name, review, reviewed_by, reviewed_on, review_rating, views, likes, comment, '', '',  location, '', noofrev, review_url, authorurl, revits]
