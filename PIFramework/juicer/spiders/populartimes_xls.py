...
class ExcelGenIOC():
    ...
    def __init__(self):
        ...
        self.excel_file_name = 'populartimes.xls' 

    def xcode(self, text, encoding='utf8', mode='strict'):
        return text.encode(encoding, mode) if isinstance(text, unicode) else text

    def get_mysql_conn(self):
        self.conn = MySQLdb.connect(db = 'Popular_times', user='root', host = 'localhost', passwd='root', charset   = "utf8", use_unicode=False)
    ...
    def excel_generation(self):
                ...
                query = "select search_keyword,Name,Address,Phone,Rating,day,timings,status,processed_time,keyword_popular_times_av
ailability, search_state,reference_url,main_url from Popular_meta"
