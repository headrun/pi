...
class ExcelGenIOC():
    ...
    def __init__(self):
        ...
        self.excel_file_name = 'pincode7.xls' 
...
'viewport_sw_lng','partial_match','place_id','types','status','reference_url','long_name','short_name','component_type','pincode']
                ...
                query = 'select sk,Pol_id,availability,formatted_address,geometry_bounds_ne_lat,geometry_bounds_ne_lng,geometry_bounds_sw_lat,geometry_bounds_sw_lng,location_lat,location_lng,location_type,viewport_ne_lat,viewport_ne_lng,viewport_sw_lat,viewport_sw_lng,partial_match,place_id,types,status,reference_url,long_name,short_name,component_type,pincode  from pincode_new  where date(modified_at)>="2017-06-22" limit 150010,50000'
		...
		for _row in rows:
			    ...
			    sk,pol_id,availability,formatted_address,geometry_bounds_ne_lat,geometry_bounds_ne_lng,geometry_bounds_sw_lat, geometry_bounds_sw_lng,location_lat, location_lng,location_type, viewport_ne_lat,viewport_ne_lng, viewport_sw_lat,viewport_sw_lng,partial_match, place_id, types,status,reference_url,long_name,short_name,component_type,pincode = _row
