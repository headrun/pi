...
class Denormxlsfile(object):
    ...
    def send_xls(self):
    	x = 'anusha'
        if x == 'anusha':
		selectall_params_ =  'select *  from pi_automation where sk = "c37595c2205ff12ffa3ab7c7460bdcb4"'
