...
DB_PASSWD = 'root'
DB_HOST = 'localhost'
DB_NAME_REQ = 'Test_PI'#'PI_AUTOMATION'
REQ_DB_NAME = 'Test_PI'#'PI_AUTOMATION'
LINKEDIN_DB = 'Test_PI'#'PI_AUTOMATION'
DB_USERNAME = 'root'
...
def get_mysql_connection(server, db_name, cursorclass=""):
    try:
        ...
        conn = MySQLdb.connect(db = DB_NAME_REQ, host = server,
                charset="utf8", use_unicode=True, user=DB_USERNAME, passwd=DB_PASSWD)
        cursor = conn.cursor()
