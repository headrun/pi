...
mailids_from_list = ['anushab@headrun.net']
...
twitter_select_qry = 'select  sk, url, meta_data from twitter_crawl where crawl_status = 0 and (created_at between "%s" and "%s") limit 1'
...
#linkedin_constants
mails_dict_ln = {'meatproject':['meatproject05@gmail.com','ram123123'],'ccv':['ccvy1.pavani1886@gmail.com','ccvy1.pavani@1886'],'smiley':['smileykutie@gmail.com','smileykutie$'], 'raja':['rajaqx@gmail.com','linkedinpw']}
